...
class PhpFieldCompletionProvider extends AbstractPhpClassMemberCompletionProvider {
    @Override
    protected void addCompletions(@NotNull CompletionParameters parameters, @NotNull ProcessingContext processingContext, @NotNull CompletionResultSet completionResultSet) {
        findPhpClassesForVariableLeftFromCaret(parameters).forEach(phpClass -> completionResultSet.addAllElements(PhpVariantsUtil.getLookupItems(phpClass.getFields(), false, null)));
    }
}
